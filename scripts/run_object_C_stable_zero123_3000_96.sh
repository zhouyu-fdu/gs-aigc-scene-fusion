...
export TRAIN_TAG="cup_bear_3000_96_gpu${PHYSICAL_GPU}"
export TEST_TAG="cup_bear_3000_96_gpu${PHYSICAL_GPU}_test"
...
echo "============================================================"
echo "[TRAIN] stable-zero123 3000 steps, 96x96 low-memory"
...
python launch.py \
  ...
  'data.random_camera.height=[96]' \
  'data.random_camera.width=[96]' \
...
if [ -n "$LATEST_MP4" ]; then
  cp "$LATEST_MP4" "$PROJECT_ROOT/final_assets/object_C_image3d/object_C_cup_bear_3000_96_final.mp4"
  echo "[DONE] copied final video:"
  echo "$PROJECT_ROOT/final_assets/object_C_image3d/object_C_cup_bear_3000_96_final.mp4"
else
  echo "[WARN] No mp4 found. Check png/gif outputs above."
fi

echo "============================================================"
echo "[DONE] Object C stable-zero123 96x96 pipeline finished."
echo "============================================================"
