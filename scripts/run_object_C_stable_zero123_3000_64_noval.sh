...
export TRAIN_TAG="cup_bear_3000_64_noval_gpu${PHYSICAL_GPU}"
export TEST_TAG="cup_bear_3000_64_noval_gpu${PHYSICAL_GPU}_test"
...
echo "============================================================"
echo "[TRAIN] stable-zero123 3000 steps, 64x64, no validation"
...
if [ -n "$LATEST_MP4" ]; then
  cp "$LATEST_MP4" "$PROJECT_ROOT/final_assets/object_C_image3d/object_C_cup_bear_3000_64_noval_final.mp4"
  echo "[DONE] copied final video:"
  echo "$PROJECT_ROOT/final_assets/object_C_image3d/object_C_cup_bear_3000_64_noval_final.mp4"
else
  echo "[WARN] No mp4 found. Check png/gif outputs above."
fi

echo "============================================================"
echo "[DONE] Object C stable-zero123 64x64 no-val pipeline finished."
echo "============================================================"
