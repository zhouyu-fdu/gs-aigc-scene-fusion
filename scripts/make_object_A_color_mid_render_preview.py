...
base = Path("outputs/object_A_3dgs/object_A_r003_color_mid_render_test")
candidates = [
...
out_path = Path("final_assets/object_A_clean/object_A_r003_color_mid_render_preview.jpg")
