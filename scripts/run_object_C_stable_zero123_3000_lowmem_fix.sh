...
export TRAIN_TAG="cup_bear_3000_lowmem_fix_gpu${PHYSICAL_GPU}"
export TEST_TAG="cup_bear_3000_lowmem_fix_gpu${PHYSICAL_GPU}_test"
...
echo "============================================================"
echo "[TRAIN] stable-zero123 3000 steps, low-memory fixed"
